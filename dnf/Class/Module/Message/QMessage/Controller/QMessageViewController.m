...
@interface QMessageViewController ()<EaseConversationListViewControllerDelegate, EaseConversationListViewControllerDataSource>
...
- (void)viewDidLoad {
    ...
    addObs(kConnectionStateChanged, networkChanged);
    
    addObs(kChatDidReceiveMessages, refresh);
    
    addObs(kUpdateConversationList, refreshDataSource);
            ...
            didSelectConversationModel:(id<IConversationModel>)conversationModel
{
    if (conversationModel) {
        ...
        if (conversation) {
            ...
            QChatUsers *chatUser = [QChatUsers seachWithUUID:conversation.conversationId];
                                    ...
                                    modelForConversation:(EMConversation *)conversation
{
    ...
    if (chatUser) {
        model.avatarURLPath = [QAliyunOSS avatarUrl:chatUser.id.stringValue].absoluteString;
        model.title = chatUser.nickname;
    }else{
...
- (void)networkChanged
{
    if ([ChatUIHelper shareHelper].connectionState == EMConnectionDisconnected) {
        self.tableView.tableHeaderView = _networkStateView;
    }
    else{
        self.tableView.tableHeaderView = nil;
