...
+ (void)initialize
{
    ...
    cell.detailLabelFont = [UIFont systemFontOfSize:13];
...
- (void)_setupSubview
{
    ...
    _avatarView.imageCornerRadius = (EaseConversationCellMinHeight-EaseConversationCellPadding*2)/2;
...
{
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.timeLabel attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.titleLabel attribute:NSLayoutAttributeTop multiplier:1.0 constant:0]];
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.timeLabel attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.titleLabel attribute:NSLayoutAttributeHeight multiplier:1.0 constant:0]];
}
