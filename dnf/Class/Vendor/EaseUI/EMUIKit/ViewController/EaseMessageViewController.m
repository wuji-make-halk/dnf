...
//    [[EaseBaseMessageCell appearance] setSendBubbleBackgroundImage:[[UIImage imageNamed:@"MessageBubble.bundle/MessageBubble_Sender"] stretchableImageWithLeftCapWidth:30 topCapHeight:24]];
//    [[EaseBaseMessageCell appearance] setRecvBubbleBackgroundImage:[[UIImage imageNamed:@"MessageBubble.bundle/MessageBubble_Receiver"] stretchableImageWithLeftCapWidth:24 topCapHeight:30]];
...
- (void)_sendMessage:(EMMessage *)message
{
    ...
    QChatUsers *chatUser = [[QChatUsers alloc] init];
    chatUser.id = [QUser current].id;
    chatUser.uuid = [QUser current].uuid;
    chatUser.nickname = [QUser current].nickname;
    
    message.ext = [chatUser mj_keyValues];
